/*
  ...
  - Added the required column `taskUrl` to the `TaskSchedule` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_TaskSchedule" ("createdAt", "id", "userId") SELECT "createdAt", "id", "userId" FROM "TaskSchedule";
